...
lost = font2.render('YOU LOSE',True,(255,255,255))
...
for i in range(1,6):
    enemy = Enemy('ufo.png', randint(80,width-80),-40,randint(1,8))
    monsters.add(enemy)

asteroids = sprite.Group()
for i in range(1,6):
    asteroid = Enemy('asteroid.png', randint(80,width-80),-40,randint(1,9))
...
while game:
    ...
    if not finish:
        ...
        text_lose = font1.render('Пропущено: '+str(lose),True,(255,255,255))
        text_win = font1.render('Счёт: '+str(score),True,(255,255,255))
